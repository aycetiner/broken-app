...
<head>
  ...
  <link rel="stylesheet" media="screen" href="/assets/main-c914843acef31ef795830338547e8e1a5be8f9338149bf17c69e14cf7a0eb5e1.css" />
  <link rel="stylesheet" media="screen" href="/assets/home-f66284d954d4a691eebf31b2c522af20636dc91e1b6f58ee92b2fb2a86da952f.css" />
...
<meta name="csrf-token" content="gb2tgnzrDPB+Bzl1H6EXRBmBgC0HK1uF6vdvl3wM2t8UHJsjb2hIcE0YptUH2+iTCpqprog204HA15TjLHtp7w==" />
...
{'GTM-T8LFJG2':true});</script>
  ...
  <script src="/assets/application-9c5725d8de76bcadb2b246af8f3557e4910dec237f82e91c5812c4dfe3261b61.js"></script>
...
<div data-event-name="click_cta" data-label="location" data-event-label="banner" class="container">
    ...
    <span class="banner-text">Looking to prepare for our full time course? Check out our free two week Private Prep course! Next class starts <u>Jan 30</u></span>
  </div>
</a>
              ...
              <li class="dropdown">
                <a href="javascript:void(0)">
                  Learn Full Time&nbsp;<span class="caret"></span>
                    ...
                    <li data-event-name="click_cta" data-label="page" data-event-label="company-projects"><a id="#company_projects" href="/company-projects">Professional Projects</a></li>
                  ...
                  <li class="dropdown">
                    <a href="javascript:void(0)">
                      ...
                      <li data-event-name="click_cta" data-label="page" data-event-label="hire">
                        <a id="#hire" href="/hire-a-grad">Hire a Rithm Grad</a>
                      </li>
                    <li>
...
<header id="home-image">
    <div class="intro-text full-width home">
        ...
        <div class="header-text">
          <h1 class="col-xs-12 col-md-12 heading">{&nbsp;A Different Kind of Bootcamp&nbsp;}</h1>
          <h4 class="text-muted">Next courses start April 3rd and July 3rd online</h4>
        </div>
    </div>
</header>
...
<section id="overview">
  <div class="row" id="icon-row">
    ...
    <svg class="home-logo" width:225, height:100 viewBox="0 0 67 74" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      ...
      <p class="text-muted">We cap our classes at 20 students. All of our instructors have years of teaching and development experience.</p>
...
/></svg>
    ...
    <div class="col-md-4 text-center">
      ...
      <p>We understand that burnout is real, and we create an experience that is sustainable for our students and staff. Our program runs from 9:30-5:30pm.</p>
...
<link rel="stylesheet" media="screen" href="/assets/outcomes_data-555089fd494f86f762ffe786b55dfedae9cb01d197258e1351498f40cb226eac.css" />

<section id="outcomes-data">
    <div class="row">
    <h2 class="service-heading">
        We're proud to have some of the best outcomes numbers around
    </h2>
    <div class="row">
      <div class="col-12 text-center">
        <div class="outcomes card">
          <div class="chart">
            <div class="header-1">% Students enrolled who graduated</div>
            <div class="header-2">Average<br>starting salary</div>
            <div class="header-3">Grads placed in less than 3 months</div>
            <div class="header-4">Grads placed in less than 6 months</div>
            <div class="header-5">Grads placed in less than 9 months</div>
            <div class="cell-1">94.74%</div>
            <div class="cell-2">$107,300</div>
            <div class="cell-3">65.71%</div>
            <div class="cell-4">82.35%</div>
            <div class="cell-5">100%</div>
          </div>
          <div class="explanatory-text">
            <p>Average data is based on 2021 graduates of our Full Stack 
            Engineering Program from Rithm's 21st, 22nd, and 23rd cohorts. Data 
            as of April 2022. 36 out of 38 enrolled students successfully 
            completed the course and graduated. Placements are defined as those 
            hired into full time roles in the field of software engineering with 
            a salary of at least $60K (salary includes only base compensation and 
            excludes bonuses, equity, relocation, and any other non-base 
            compensation), plus a small percentage (8.33%) of graduates who were 
            selected to join the Rithm instructional and engineering teams. 
            Average starting salary and placement times are from the same 
   ...
   <div class="service-heading">
    ...
    <div class="row">
        <article class="card col-md-4">
          <a href="/blog/grads-win-stepzen-hackathon">
            <h4>
              Rithm Grads Win First Place in StepZen Hackathon
            </h4>
              <time pubdate="" datetime="2022-09-06 18:17:36 UTC"></time>
            <h5>
              <small>September 06, 2022</small>
            </h5>
</a>        </article>
        <article class="card col-md-4">
          <a href="/blog/choosing-a-bootcamp">
            <h4>
              Choosing the Right Bootcamp
            </h4>
              <time pubdate="" datetime="2022-06-23 21:16:57 UTC"></time>
            <h5>
              <small>June 23, 2022</small>
            </h5>
</a>        </article>
        <article class="card col-md-4">
          <a href="/blog/grads-at-google">
            <h4>
              Interview: Rithm Grads at Google
            </h4>
              <time pubdate="" datetime="2022-05-27 14:33:30 UTC"></time>
            <h5>
      ...
      <div class="row">
        <article class="card col-md-4">
          <a href="/blog/pinterest-internship">
            <h4>
              Three Rithm Students Accepted to the 2022 Pinterest Engineering Internship
            </h4>
              <time pubdate="" datetime="2022-05-13 15:59:12 UTC"></time>
            <h5>
              <small>May 13, 2022</small>
            </h5>
</a>        </article>
        <article class="card col-md-4">
          <a href="/blog/top-5-admissions-questions">
            <h4>
              The Top 5 Questions People Ask About Rithm School
            </h4>
              <time pubdate="" datetime="2022-03-21 14:02:41 UTC"></time>
            <h5>
    ...
    <div class="row">
        <div class="col-md-3 col-sm-4 text-center">
            <a style="padding:0;" class="footer-logo" href="/">
              <img class="logo" width="120" height="58" alt="rithm school company logo" title="Rithm School Logo" src="/assets/logos/rithm_logo-f188d2545d88917c033e407f4f87b02e2a3f5cf5dfb60e626787785fa9c13774.svg" />
                ...
                <a class="text-muted faq-url" href="/cdn-cgi/l/email-protection#dcb5b2bab39caeb5a8b4b1afbfb4b3b3b0f2bfb3b1">info@rithmschool.com</a>
            </span>
        </div>
        ...
        <div class="col-md-3 col-sm-4 text-center">
          <ul class="list-inline social-buttons">
              ...
              <li data-event-name="click_cta" data-label="click_social_link" data-event-label="instagram"><a target="_blank" href="https://www.instagram.com/rithmschool"><i class="fa fa-instagram"></i></a>
              </li>
...
<input type="hidden" name="authenticity_token" id="authenticity_token" value="vLj60X8BCJ8c/LPc95Z9k6Zs+w4R/dZltjyJoR07xYEpGcxwbIJMHy/jLHzv7IJEtXfSjZ7gXmGcHHLVTUx2sQ==" />  <div id="modal-email-known" style="display:none;">
...
<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script>(function(){var js = "window['__CF$cv$params']={r:'7899f0b3a9f52340',m:'U0s4OeqwsXXD1ewwqBUqRUdWxiJDpalekWoRfWzkYlo-1673736727-0-AZ/1XeC1KmwYKZnKivrR8k6YwxL6XXiRlgxHTqK6/ki9m8O/lG56BtxGR8e53umkTJrEfvkqIU9PPwDGx5jOwRjExKxMpR8R4h0tOEacazxEEave8EgJUWjHHvOW/jPKFQ==',s:[0x4f26137afa,0x12dfa35b2d],u:'/cdn-cgi/challenge-platform/h/g'};var now=Date.now()/1000,offset=14400,ts=''+(Math.floor(now)-Math.floor(now%offset)),_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/h/g/scripts/alpha/invisible.js?ts='+ts,document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();</script></body>
</html>
