...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2023-01-14T22:45:00.496535" />
  ...
  <link href="/media/css/fontawesome.css?e4fcc562" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
  <link rel="stylesheet" type="text/css" href="/dyncss/base.css?e4fcc562">

  <script src="/media/js/theme.js?e4fcc562"></script>
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pgformatter-54-released-2569/">pgFormatter 5.4 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-01-11 by MigOps</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5DB"> Announcing Release 16 of the PostgreSQL Buildfarm client</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Andrew Dunstan</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-01-14</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5DA"> How to Solve Advent of Code 2022 Using Postgres - Day 12</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Greg Sabino Mullane</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-01-13</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Dx"> Avoiding Constraint violations while migrating Oracle to PostgreSQL – DATE </a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Dz"> Beyond Joins and Indexes</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Bruce Momjian</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-01-12</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5BS"> RETURNING Modified Rows</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5BR"> PGSQL Phriday #004 Recap</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5Dy"> From Numbers to Words using Perl (and Lingua::)!</a></h3>
            <ul class="meta">
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?e4fcc562"></script>
